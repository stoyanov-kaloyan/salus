...
::: {.statement}
В реална среда нямаме време за ръчна проверка на всяка снимка.
Трябва ни бърз филтър, който в рамките на секунди да сигнализира
за deepfake, NSFW и синтетично генерирани изображения.
:::

<span class="tag">Real-time</span><span class="tag">Explainable output</span><span class="tag">Modular models</span>
